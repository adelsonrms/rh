...
{
    public class User : Microsoft.Graph.User
    {
        public bool IsValid() => !string.IsNullOrEmpty(this.Id);
        public Response Response { get; set; }
    }
    public class ProfilePhoto : Microsoft.Graph.ProfilePhoto
    {
        public bool IsValid() => !string.IsNullOrEmpty(this.Id);
        public Response Response { get; set; }
    }
    public class Message : Microsoft.Graph.Message
    {
        public bool IsValid() => !string.IsNullOrEmpty(this.Id);
        public Response Response { get; set; }
        public string DataCriacao => this.CreatedDateTime?.ToString("dd/MM/yyyy hh:mm:ss");
        public string DataModificacao => this.LastModifiedDateTime?.ToString("dd/MM/yyyy hh:mm:ss");
        public string DataRecebimento => this.ReceivedDateTime?.ToString("dd/MM/yyyy hh:mm:ss");
    }
